    ...
    <div>
      <div className='bg-two font-fonty px-16 py-24'>
        <div className='flex flex-col items-center lg:flex-row lg:justify-around'>
          ...
          <div className='flex flex-col place-items-center text-center space-y-10'>
            ...
            <a href="/about" class="px-5 py-3 text-lg font-medium text-center text-three border border-gray-300 rounded-lg hover:bg-three hover:text-two">Know More</a>
          </div>
        </div>
      </div>
      ...
      <div className='bg-two font-fonty px-16 py-24'>
        <div className='flex flex-col items-center'>
          ...
          <a href="/academics" class="items-center justify-center mt-10 px-5 py-3 text-lg font-medium text-center text-three border border-gray-300 rounded-lg hover:bg-three hover:text-two">Know More</a>
        </div>
      </div>
      <hr className='h-px w-3/4 m-auto border-0 bg-five' />
      <div className='bg-two font-fonty px-16 py-24'>
