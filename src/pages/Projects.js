    ...
    <div className="bg-two font-fonty cursor-default select-none py-24">
      ...
      <div className='flex flex-col py-10 mx-8 items-center text-center space-y-16'>
        <div class="max-w-4xl rounded p-5 bg-three lg:hover:scale-105 overflow-hidden shadow-lg shadow-five">
          ...
          <div class="px-6 py-4">
            <div class="font-bold text-xl mb-2">CA Dashboard</div>
            <p class="text-two text-base">This project was for a company of a Charted Accountant. In this project I have made the ui for singup, login, otp verification and forgot password. Apart from this it also consists of two different dashboards for two different type of users.</p>
          </div>
        ...
        <div class="max-w-4xl rounded p-5 bg-three lg:hover:scale-105 overflow-hidden shadow-lg shadow-five">
          ...
          <div class="px-6 py-4">
            <div class="font-bold text-xl mb-2">Anusaran Project</div>
            <p class="text-two text-base">In this project I developed the ui and idea behind the project was to make the way of teaching online from creating courses to taking attendance everything in one app. I don't have the preview but you can see the code on github.</p>
          </div>
